function [Group, fitness_cost, realnum] = decode( Group,pop_size,n,k,m )
low = 5;
up = 36;
b = (up-low)/(2^5-1);
M = 100000;
...
% demand=[8	22	33	7	20	17	15	32	20	29	34	16	16	28	35	27	32	33	12	32];
demand=[23	14	29	8	32	12	18	34	31	36	7	8	28	36	31	29	6	31	30	24];
% demand=[35	20	32	32	16	17	7	19	34	34	17	31	35	12	32	26	30	7	17	15];
% demand=[35	31	8	14	21	32	10	33	36	36	32	13	16	34	21	33	27	30	16	8];
% demand=[22	36	30	10	23	30	31	20	20	18	31	22	34	32	30	7	32	31	32	15];
% demand=[33	36	25	29	32	23	35	30	31	33	12	35	16	35	26	36	6	35	33	29];
% demand=[19	35	32	33	9	36	22	31	8	30	32	25	34	11	31	33	32	15	30	31];
% demand=[34	34	19	32	33	9	35	25	34	32	16	33	14	36	35	33	34	18	35	36];
% demand=[33	18	32	36	36	33	33	31	14	12	31	36	30	26	8	31	30	30	33	35];
